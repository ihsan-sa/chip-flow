...
(held-out copy: holdout/ runs as its own cocotb test dir, so it carries
its own model rather than importing tb/).
Not a test module; the held-out tests in this directory import it.
